<meta charset="utf-8">
		...
		<!-- Basic Styles -->
                                             ...
                                             {{ HTML::style('css/font-awesome.min.css', array('rel' => 'stylesheet', 'media' => 'screen')) }}
	

		<!-- SmartAdmin Styles : Caution! DO NOT change the order -->
                                            {{ HTML::style('css/smartadmin-production-plugins.min.css', array('rel' => 'stylesheet', 'media' => 'screen')) }}
                                            {{ HTML::style('css/smartadmin-production.min.css', array('rel' => 'stylesheet', 'media' => 'screen')) }}
                                            {{ HTML::style('css/smartadmin-skins.min.css', array('rel' => 'stylesheet', 'media' => 'screen')) }}

		<!-- SmartAdmin RTL Support -->
                                            {{ HTML::style('css/smartadmin-rtl.min.css', array('rel' => 'stylesheet', 'media' => 'screen')) }}
